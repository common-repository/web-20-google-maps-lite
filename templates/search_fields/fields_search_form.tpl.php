...
<script>
	...
	<?php endforeach; ?>
			...
			function hideShowFields(id) {
				...
				$(".w2gm-field-search-block-<?php echo $random_id; ?>").hide();
				$.each(fields_in_categories, function(index, value) {
					...
					if (value != undefined) {
						...
						if ((value.length == 0 || show_field) && $(".w2gm-field-search-block-"+index+"_<?php echo $random_id; ?>").length)
							$(".w2gm-field-search-block-"+index+"_<?php echo $random_id; ?>").show();
					}
				});
			}
		});
...
<div id="w2gm_search_fields_<?php echo $random_id; ?>">
	<div id="w2gm_standard_search_fields_<?php echo $random_id; ?>" class="w2gm_search_fields_block">
	...
	<div id="w2gm_advanced_search_fields_<?php echo $random_id; ?>" <?php if (!$advanced_open): ?>style="display: none;"<?php endif; ?> class="w2gm_search_fields_block">
