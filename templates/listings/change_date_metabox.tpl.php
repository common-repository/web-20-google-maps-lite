...
<p><?php _e("Set new expiration date and time of the listing.<br />Be careful: If you'll set past date - listing will expire in some minutes.", 'W2GM'); ?></p>

<div class="w2gm-content w2gm-content-fields-metabox">
	<div class="w2gm-field w2gm-form-group w2gm-form-horizontal">
		<label class="w2gm-col-md-1 w2gm-control-label">
			<?php _e('Date:', 'W2GM'); ?>
		</label>
		<div class="w2gm-col-md-3 w2gm-has-feedback">
			<input type="text" id="expiration_date" class="w2gm-form-control" />
			<span class="w2gm-glyphicon w2gm-glyphicon-calendar w2gm-form-control-feedback"></span>
		</div>
		<label class="w2gm-col-md-1 w2gm-control-label"><?php _e('Time:', 'W2GM'); ?></label>
		<div class="w2gm-col-md-3">
			...
			<select name="expiration_date_hour" class="w2gm-form-control">
		...
		<div class="w2gm-col-md-3">
			<select name="expiration_date_minute" class="w2gm-form-control">
...
<?php do_action('w2gm_changedate_html', $listing); ?>