...
class w2gm_content_field_hours extends w2gm_content_field {
	...
	public function renderInput() {
		...
		w2gm_renderTemplate('content_fields/fields/hours_input.tpl.php', array('content_field' => $this, 'week_days' => $week_days));
	}
	...
	public function renderOutput($listing = null) {
		w2gm_renderTemplate('content_fields/fields/hours_output.tpl.php', array('content_field' => $this, 'listing' => $listing));
	}
