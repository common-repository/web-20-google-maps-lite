<?php if(!$is_compact) echo VP_W2GM_View::instance()->load('control/template_control_head', $head_info); ?>
...
<?php if(!$is_compact) echo VP_W2GM_View::instance()->load('control/template_control_foot'); ?>