...
return array(
	...
	'scripts' => array(
		...
		'paths' => array(
			...
			'bootstrap-colorpicker' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/bootstrap-colorpicker.js',
				'deps'     => array('jquery'),
				'ver'      => false,
			),
			'tipsy' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/jquery.tipsy.js',
				'deps'     => array('jquery'),
				'ver'      => '1.0.0a'
			),
			'scrollspy' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/jquery-scrollspy.js',
				'deps'     => array('jquery'),
				'ver'      => false,
			),
			...
			'jquery-typing' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/jquery.typing-0.2.0.min.js',
				'deps'     => array('jquery'),
				'ver'      => '0.2',
			),
			'ace-editor' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/ace/ace.js',
				'deps'     => array(),
				'ver'      => '1.0.0',
			),
			'select2' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/select2.min.js',
				'deps'     => array('jquery'),
				'ver'      => '3.3.2',
				'override' => true,
			),
			'select2-sortable' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/select2.sortable.js',
				'deps'     => array('jquery', 'jquery-ui-sortable', 'select2'),
				'ver'      => '1.0.0',
				'override' => true,
			),
			'reveal' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/vendor/jquery.reveal.js',
				'deps'     => array('jquery'),
				'ver'      => '1.0.0',
			),
			'kia-metabox' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/kia-metabox.js',
				'deps'     => array('jquery', 'editor'),
				'ver'      => '1.0',
				'override' => true,
			),
			'w2gm_shared' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/w2gm_shared.min.js',
				'deps'     => array(),
				'ver'      => '1.1',
				'localize' => array(
					'name' => 'vp_w2gm_wp',
			...
			'vp-option' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/option.min.js',
				'deps'     => array(),
				'ver'      => '2.0',
				'localize' => array(
					'name' => 'vp_w2gm_opt',
			...
			'vp-metabox' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/metabox.min.js',
				'deps'     => array(),
				'ver'      => '2.0',
				'localize' => array(
					'name' => 'vp_w2gm_mb',
			...
			'vp-shortcode-qt' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/shortcode-quicktags.js',
				'deps'     => array('reveal'),
				'ver'      => '1.0.0',
			),
			'vp-shortcode' => array(
				'path'     => VP_W2GM_PUBLIC_URL . '/js/shortcode-menu.js',
	 ...
	 */
	'styles' => array(
		'always' => array('tipsy', 'font-awesome_w2gm'),
		'paths' => array(
			'bootstrap-colorpicker' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/vendor/bootstrap-colorpicker.css',
				'deps' => array(),
			),
			'tipsy' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/vendor/tipsy.css',
				'deps' => array(),
			),
			'jqui' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/vendor/jqueryui/themes/' . $jqui_theme . '/jquery-ui-1.9.2.custom.min.css',
				'deps' => array(),
			),
			'font-awesome_w2gm' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/vendor/font-awesome.min.css',
				'deps' => array(),
			),
			'select2' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/vendor/select2.css',
				'deps' => array(),
			),
			'reveal' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/vendor/reveal.css',
				'deps' => array(),
			),
			'vp-option' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/option.min.css',
				'deps' => array(),
			),
			'vp-metabox' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/metabox.min.css',
				'deps' => array(),
			),
			'vp-shortcode' => array(
				'path' => VP_W2GM_PUBLIC_URL . '/css/shortcode.min.css',
				'deps' => array('reveal'),
			),
		),
	),
